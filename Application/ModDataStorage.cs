...
public static class ModDataStorage
{
    ...
    public static void ComposeMod()
    {
        ...
        Logger.AddLog($"Provinces Intalized:{Mod.Map.Provinces.Count}, some rng obj:{Mod.Map.Provinces.Random().Id.ToString()}");
        ...
        Logger.AddLog($"SubUnitComposer Intalized:{Mod.SubUnits.Count}, some rng obj:{Mod.SubUnits.Random().Id.ToString()}");
