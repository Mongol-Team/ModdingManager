...
public class SuperEventHandler
{
    ...
    public void SaveSupereventAudioFile()
    {
        ...
        try
        {
            ...
            string destinationDirectory = Path.Combine(ModManagerSettings.ModDirectory, "sound", "customsound");
    ...
    public void CreateCustomAssetsFiles()
    {
        ...
        string soundDirectory = Path.Combine(ModManagerSettings.ModDirectory, "sound");
    ...
    public void HandleButtonsImage()
    {
        ...
        string dir = Path.Combine(ModManagerSettings.ModDirectory, "gfx", "superevent", "button");
    ...
    public void SaveSupereventImages()
    {
        ...
        {
            string imageDir = Path.Combine(ModManagerSettings.ModDirectory, "gfx", "superevent_pictures");
        ...
        {
            string frameDir = Path.Combine(ModManagerSettings.ModDirectory, "gfx", "interface", "superevent");
    ...
    {
        string fontsDirectory = Path.Combine(ModManagerSettings.ModDirectory, "gfx", "fonts");
