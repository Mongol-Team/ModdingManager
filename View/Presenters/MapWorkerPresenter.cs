...
//{
//    public class MapWorkerPresenter
//    {
...
//        public MapWorkerPresenter(IStateWorkerView view)
//        {
//            _view = view;
...
//            //if (ModDataStorage.Mod.Map?.StrategicRegions == null || ModDataStorage.Mod.Map.Provinces == null)
//            //    return;
...
//            //foreach (var province in ModDataStorage.Mod.Map.Basic.FileEntitiesToList())
//            //{
...
//            //if (ModDataStorage.Mod.Map?.Countries == null || ModDataStorage.Mod.Map.Provinces == null)
//            //    return;
